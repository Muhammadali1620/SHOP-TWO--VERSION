    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateField(default=datetime.datetime(2024, 5, 24, 9, 9, 29, 64802, tzinfo=datetime.timezone.utc))),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping', models.DecimalField(decimal_places=2, default=0, max_digits=20)),
